    ...
    <div className="bg-gray-50 shadow-md p-4 pt-4">
      ...
      {menuOpen && (
        <ul className="md:hidden mt-4 flex flex-col gap-4 text-base font-semibold">
          <li className="cursor-pointer">offers</li>
          <li className="cursor-pointer">Help</li>
          <li className="cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-icon lucide-user"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>Aditya</li>
          <li className="cursor-pointer">Cart</li>
        </ul>
      )}
    </div>
